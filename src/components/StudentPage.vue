              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8">{{info.studentId}}</div>
                  </div>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Program</div>
                    <div class="col-lg-9 col-md-8">{{info.programName}}</div>
                  </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8">{{info.departmentName}}</div>
                  </div>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Faculty</div>
                    <div class="col-lg-9 col-md-8">{{info.facultyName}}</div>
                  </div>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Batch</div>
                    <div class="col-lg-9 col-md-8">{{info.batchNo}}</div>
                  </div>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Campus Name</div>
                    <div class="col-lg-9 col-md-8">{{info.campusName}}</div>
                  </div>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Shift</div>
                    <div class="col-lg-9 col-md-8">{{info.shift}}</div>
                  </div>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Semester</div>
                    <div class="col-lg-9 col-md-8">{{info.semesterName}}</div>
                  </div>
                  ...
                  <form>
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <img src="/template/assets/img/profile-img.jpg" alt="Profile">
                        <div class="pt-2">
